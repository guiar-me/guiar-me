...
void main() async {
  ...
  setUpAll(() async {
    ...
    planRepository = PlanRepository(getIt());
  ...
  group('PlanRepository tests', () {
    test('it should return paginated plans', () async {
      // Act
      Either<PaginatedData<PlanModel>> result = await planRepository.index();

      // Assert
      PaginatedData<PlanModel> paginatedData = result.right!;
